...
fn s_topic(id: &str) -> String {
    format!("homeassistant/sensor/maratui_{id}/state")
}

fn b_topic(id: &str) -> String {
    format!("homeassistant/binary_sensor/maratui_{id}/state")
}
...
fn sensor_config(id: &str, name: &str, extra: &str) -> (String, String) {
    ...
    (
        ...
        format!(
            r#"{{"name":"{name}","unique_id":"maratui_{id}","state_topic":"homeassistant/sensor/maratui_{id}/state","device":{DEVICE}{extra_part}}}"#
        ),
    )
}
...
fn binary_config(id: &str, name: &str, extra: &str) -> (String, String) {
    ...
    (
        ...
        format!(
            r#"{{"name":"{name}","unique_id":"maratui_{id}","state_topic":"homeassistant/binary_sensor/maratui_{id}/state","payload_on":"ON","payload_off":"OFF","device":{DEVICE}{extra_part}}}"#
        ),
    )
}
